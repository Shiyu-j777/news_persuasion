...
output_file = "/scratch/sj4461/congressional_inference/aggregate_inferred_congressional_record_filter_words_{count}.parquet"
...
rule all:
    input:
        expand(output_file, count = filter_count)
